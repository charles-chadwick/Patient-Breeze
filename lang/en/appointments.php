...
return [
    'index' => [
        ...
        'search_placeholder' => 'Search by patient name or MRN…',
        'search_all_dates' => 'Showing matches from all dates.',
        'filter_staff' => 'Filter by staff…',
        'filter_staff_searching' => 'Searching…',
        'filter_staff_empty' => 'No staff match your search.',
        'empty' => 'No appointments found for this period.',
        'empty_search' => 'No appointments match your search.',
        'detail_date' => 'Date',
        'detail_time' => 'Time',
